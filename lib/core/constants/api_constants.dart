...
class ApiConstants {
  ...
  static String groupInvitations(String groupId) => '/invitations/group/$groupId';
  ...
  static String paymentsByPerson(String personId) => '/payments/person/$personId';
  ...
  static String contributionsByTour(String tourId) => '/contributions/tour/$tourId';
  static String contributionsByMember(String personId) => '/contributions/member/$personId';
